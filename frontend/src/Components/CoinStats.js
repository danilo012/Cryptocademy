...
const CoinStats = ({data}) => {
  ...
  return (
    <>
        {/* price converter */}
        <h2 className='text-2xl md:text-4xl mx-4 text-white font-title mb-4 font-bold '>Price Converter</h2>
        ...
        <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2  mt-8">
            <div className='mx-8'>
                ...
                <p className='text-gray-200 text-lg '>
                    The live {data.name} price today is ${data.market_data.current_price.usd} USD. We update our <span className="uppercase">{data.symbol}</span> to USD price in real-time. {data.name} is  
                    ...
                    in the last 24 hours. The current market cap ranking is #{data.market_data.market_cap_rank}, with a live market cap of ${data.market_data.market_cap.usd} USD. It has a circulating supply of {data.market_data.circulating_supply} <span className="uppercase">{data.symbol}</span> coins.
                </p>
            </div>
            ...
            <div class=" shadow-lg mx-auto rounded-2xl bg-white dark:bg-black w-[90%]">
                ...
                <ul>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className='text-xl'>
                                {data.community_data.twitter_followers ? data.community_data.twitter_followers : "-"}
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className='text-xl'>
                            {data.community_data.reddit_average_posts_48h ? data.community_data.reddit_average_posts_48h : "-"}
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className='text-xl'>
                                {data.community_data.reddit_average_comments_48h ? data.community_data.reddit_average_comments_48h : "-"}
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className='text-xl'>
                                {data.community_data.reddit_subscribers ? data.community_data.reddit_subscribers : "-"}
                            </p>
                        </div>
                    </li>
            ...
            <div class=" shadow-lg mx-auto rounded-2xl bg-white dark:bg-black w-[90%]">
                ...
                <ul>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className={ `text-xl text-left font-bold my-2 ${data?.market_data.price_change_percentage_1h_in_currency.usd >= 0 ? "text-green-400" : "text-red-400"} `}>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className={ `text-xl text-left font-bold my-2 ${data?.market_data.price_change_percentage_24h_in_currency.usd >= 0 ? "text-green-400" : "text-red-400"} `}>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className={ `text-xl text-left font-bold my-2 ${data?.market_data.price_change_percentage_7d_in_currency.usd >= 0 ? "text-green-400" : "text-red-400"} `}>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className={ `text-xl text-left font-bold my-2 ${data?.market_data.price_change_percentage_14d_in_currency.usd >= 0 ? "text-green-400" : "text-red-400"} `}>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className={ `text-xl text-left font-bold my-2 ${data?.market_data.price_change_percentage_30d_in_currency.usd >= 0 ? "text-green-400" : "text-red-400"} `}>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className={ `text-xl text-left font-bold my-2 ${data?.market_data.price_change_percentage_60d_in_currency.usd >= 0 ? "text-green-400" : "text-red-400"} `}>
                    ...
                    <li class="flex items-center text-gray-200 justify-between py-3 border-b-2 border-gray-800 ">
                        ...
                        <div>
                            <p className={ `text-xl text-left font-bold my-2 ${data?.market_data.price_change_percentage_1y_in_currency.usd >= 0 ? "text-green-400" : "text-red-400"} `}>
