...
const FormAppInfo = () => {
  return (
    <div>
        <div className="hidden md:block lg:h-screen px-4 py-10 space-y-8 bg-gradient-to-b from-black to-gray-900 text-white xl:py-32 md:px-40 lg:px-20 xl:px-40">
            {/* logo */}
            <h1 className='text-5xl font-bold text-white font-redressed tracking-wide'>Cryptocademy </h1>
