  ...
  return (
    <>
        <div className="hidden md:block  px-4  bg-gradient-to-b from-black to-gray-900 text-white xl:py-20 md:px-40 lg:px-20 xl:px-40">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-none w-6 h-6 mt-[0.3rem] text-green-400">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <div >
                <h2 className="text-2xl font-medium text-green-400">Discover the future of digital finance.</h2>
            ...
            <div>
                <h2 className="text-2xl font-medium text-green-400">Keep track of your virtual portfolios.</h2>
                <p className="mt-3 text-gray-300">
