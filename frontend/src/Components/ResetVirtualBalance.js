            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div className="relative rounded-lg shadow bg-gray-700">
                    ...
                    <div className="flex items-center p-6 space-x-2 rounded-b border-t border-gray-600">
                        ...
                        disabled={resetLoading} type="button" className="text-white bg-blue-700  focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
                            {
