...
const ErrorToast = forwardRef(({message},ref) => {
  ...
  return (
      <div id={showToast ? "show" : "hide"} className="flex w-[90%] md:w-auto p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200 absolute top-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2   z-50 " role="alert">
        ...
        <button onClick={()=> setShowToast(false)} type="button" className="ml-auto -mx-1.5 -my-1.5 bg-red-100 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex h-8 w-8 dark:bg-red-200 dark:text-red-600 dark:hover:bg-red-300" data-collapse-toggle="alert-2" aria-label="Close">
