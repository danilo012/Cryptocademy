...
const SuccessToast = forwardRef(({message},ref) => {
  ...
  return (
      <div id={showToast ? "show" : "hide"} className="flex w-[90%] md:w-auto p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200 absolute top-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2   z-50 " role="alert">
        ...
        <button onClick={()=> setShowToast(false)} type="button" className="ml-auto -mx-1.5 -my-1.5 bg-green-100 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-green-200 dark:text-green-600 dark:hover:bg-green-300" data-collapse-toggle="alert-2" aria-label="Close">
