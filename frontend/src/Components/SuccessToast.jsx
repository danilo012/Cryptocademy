...
const SuccessToast = forwardRef(({ message }, ref) => {
  ...
  return (
    <div
      ...
      className="flex w-[90%] md:w-auto p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200 absolute top-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2   z-50 "
      role="alert"
    >
      <svg
