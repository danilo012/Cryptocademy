        ...
        <motion.div 
          ...
          <p className='text-white font-bold text-2xl md:text-3xl font-title mt-4 ml-3'>Global Metrics</p>
          {
            ...
            <div className='flex flex-wrap justify-center md:justify-start'>
                ...
                <div className="  bg-gradient-to-tr from-gray-900 to-gray-700   overflow-hidden shadow rounded-lg w-60 md:w-72 relative mx-3 mt-4">
                        <img src="https://img.icons8.com/external-icongeek26-flat-icongeek26/64/000000/external-bank-business-and-finance-icongeek26-flat-icongeek26.png" alt="btc logo" className="h-24 w-24 rounded-full absolute opacity-50 -top-3 -right-6 md:-right-2"/>
                        <div className="px-4 py-5 sm:p-6">
                            <dl>
                                <dt className="text-sm leading-5 font-medium text-gray-400 truncate">
                                    Markets
                ...
                <div className="  bg-gradient-to-tr from-gray-900 to-gray-700   overflow-hidden shadow rounded-lg w-60 md:w-72 relative mx-3 mt-4">
                        <img src="https://img.icons8.com/external-photo3ideastudio-flat-photo3ideastudio/64/000000/external-bank-building-photo3ideastudio-flat-photo3ideastudio.png" alt="btc logo" className="h-20 w-20  absolute opacity-50 -top-3 -right-6 md:-right-2"/>
                        <div className="px-4 py-5 sm:p-6">
                            <dl>
                                <dt className="text-sm leading-5 font-medium text-gray-400 truncate">
                                    Total Volume
          ...
          <p className='text-white font-bold text-2xl md:text-3xl font-title mt-8 ml-3'>Market Dominance</p>
          {
              fetchGlobalCryptoSuccess &&
              <PieChart globalCryptoData={globalCryptoData}/>
          }
