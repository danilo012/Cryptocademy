    ...
    >
      ...
      <div className="flex flex-row min-h-screen bg-black text-gray-800 md:overflow-x-hidden pt-6 md:pt-0">
        ...
        >
            ...
            <h1 className='text-white font-bold text-2xl md:text-3xl font-title my-4 ml-3 px-2 md:px-4'>Courses & Blogs</h1>
            <p className='text-gray-300 text-base mb-4 ml-3 px-2 md:px-4'>
                Many people are unfamiliar with cryptocurrency, but it is likely to gain more traction in the future.
                Along with using cryptocademy to engage in real-time mock trading, here is a curated list of articles & courses published by experts to help you immerse yourself in the world of crypto assets.
            </p>

            <h1 className='text-white font-bold text-lg md:text-xl font-title my-8 ml-3 px-2 md:px-4'>Introduction To Cryptocurrency & Blockchain</h1>
            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 px-4 md:px-8">
                ...
                href="https://dev.to/narottam04/web-10-web-20-web-30-explained-591n" rel='noreferrer'target="_blank"
                >
                    <span
                ...
                <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://hackernoon.com/wtf-is-the-blockchain-1da89ba19348" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
                    ...
                    <div className="justify-between sm:flex">
                        ...
                        <p className="mt-1 text-xs font-medium text-gray-400">By Mohit Mamoria on Hackernoon</p>
                        </div>
                ...
                <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://dev.to/narottam04/how-cryptocurrency-works-explained-visually-2j32" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
                    ...
                    <div className="mt-4 sm:pr-8">
                        <p className="text-sm text-gray-500 line-clamp-4">
                        In 2008, when Lehman Brothers Holdings Inc. filed for bankruptcy, it shook people's faith in banks so much that a new class of assets appeared without formal bank backing. The first cryptocurrency named Bitcoin was invented in 2008 by an unknown person or group of people using the name Satoshi Nakamoto. 
                ...
                <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://academy.binance.com/en/articles/what-is-cryptocurrency-mining" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
                ...
                <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://academy.binance.com/en/articles/proof-of-work-explained" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
                ...
                <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://academy.binance.com/en/articles/mining-pools-explained" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
            ...
            <h1 className='text-white font-bold text-lg md:text-xl font-title my-8 ml-3 px-2 md:px-4'>Cryptocurrency Trading</h1>

            <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 px-4 md:px-8">

            <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://academy.binance.com/en/articles/a-complete-guide-to-cryptocurrency-trading-for-beginners?" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
            ...
            <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://academy.binance.com/en/articles/how-to-trade-with-hammer-candlestick-patterns" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
            ...
            <h1 className='text-white font-bold text-lg md:text-xl font-title my-8 ml-3 px-2 md:px-4'>Other quality resources</h1>

            <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 px-4 md:px-8">

                <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://academy.binance.com/en" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
                ...
                <a
                className="relative block p-8 overflow-hidden border border-gray-100 rounded-lg"
                href="https://a16z.com/2018/02/10/crypto-readings-resources/" rel='noreferrer'target="_blank"
                >
                    <span
                        className="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"
                    ></span>
